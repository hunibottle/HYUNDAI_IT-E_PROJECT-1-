            ...
            <div id="handsomeCust" class="login_wrap box_type_1 renewal1904">
                <div class="border_box1">
                    ...
                    <div class="inner_box">
                        ...
                        <div id="hpIPLogin">
                            <form id="loginForm" name="loginForm" method = "post" action ="../BoardServlet?command=update">
                                ...
                                <fieldset>
                                    ...
                                    <div class="login_section">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <input type="password" id="j_password" name="user_pwd"
                                                    placeholder="비밀번호를 입력하세요." title="비밀번호">
                                            </div>
                                            
                                            <div>
                                                <input type="text" id="j_password" name="user_name"
                        ...
                        <div class="section_bottom"  style = "height:0px;">
                        </div> -->
                    </div>
                </div>
            </div>
