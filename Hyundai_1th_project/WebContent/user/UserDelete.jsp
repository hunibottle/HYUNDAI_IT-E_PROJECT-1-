...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/Hyundai_1th_project/css/mypage.css">
	<link rel="stylesheet" href="http://localhost:8080/Hyundai_1th_project/css/submenu.css">
    <link rel="stylesheet" href="http://localhost:8080/Hyundai_1th_project/css/header.css">    
        
        
    <link rel="shortcut icon"
        href="http://cdn.thehandsome.com/_ui/desktop/common/images/common/thehandsome_ic_16x16.ico">
    <link rel="stylesheet" type="text/css" href="/_ui/desktop/common/css/font_443.css" media="all">
    <link rel="stylesheet" type="text/css" href="/_ui/desktop/common/css/common.css?20210818" media="all">
    <link rel="stylesheet" type="text/css" href="/_ui/desktop/common/css/layout.css?20210826" media="all">
    ...
    <link rel="stylesheet" type="text/css" href="/_ui/desktop/common/css/footer.css" media="all">
    <link rel="stylesheet" type="text/css" href="/_ui/desktop/common/css/contents.css?20220221" media="all">
    ...
    <script type="text/javascript" src="https://js.appboycdn.com/web-sdk/2.7/appboy.min.js" async=""></script>
    <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script>
    <script type="text/javascript" async=""
        src="https://www.googletagmanager.com/gtag/js?id=G-RPZ82BN53C&amp;l=dataLayer&amp;cx=c"></script>
    <script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-5PCJDFJ"></script>
    <script async="" src="https://www.google-analytics.com/analytics.js"></script>
    <script src="https://connect.facebook.net/signals/config/1947530058811697?v=2.9.55&amp;r=stable" async=""></script>
    <script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script>
    <script async="" charset="utf-8" src="//static.recopick.com/dist/production.min.js"></script>
    <script type="text/javascript" src="/_ui/desktop/common/js/jquery-1.11.2.min.js"></script>
    
    <script type="text/javascript">
    $(function(){
    	$('#delOk').click(funcion()){
    	if (confirm("삭제 하시려면 확인(예) 또는 취소(아니오)를 선택해주세요.")) {
    	         return true;
    	 }	
    	 else{
    		    return false; 
    ...
    <script type="text/javascript">
        ...
        ACC.config.CSRFToken = "89c930a0-1bdd-4655-a822-26b9a2f5375b";
    ...
    <script type="text/javascript" src="/_ui/desktop/common/js/common_function.js"></script>
    ...
    <script type="text/javascript">
        var setDimensionData = function () {
            ...
            pageviewObj.dimension16 = entrySite;                    //채널_언어
    ...
    <script>
        ...
        < !--recoPick END---->
            ...
            function setCategoryNameInKO(targetCateCode, defaultCateName) {
                var cates = "AS|잡화^AS01|여성슈즈^AS011|부츠^AS012|로퍼/블로퍼^AS013|스니커즈^AS014|플랫^AS015|힐/슬링백^AS016|샌들/슬라이드^AS017|기타 슈즈^AS02|남성슈즈^AS021|부츠^AS022|포멀슈즈^AS023|스니커즈^AS024|샌들/슬라이드^AS025|기타 슈즈^AS031|토트백^AS032|숄더/크로스바디백^AS033|클러치 백^AS034|기타 백^AS041|토트백^AS042|숄더/크로스바디백^AS043|클러치 백^AS044|기타 백^AS051|머플러^AS052|스카프^AS061|이어링/커프^AS062|목걸이^AS063|팔찌^AS064|반지^AS065|기타 주얼리^AS071|모자^AS072|양말^AS073|장갑^AS074|벨트^AS075|지갑^AS076|헤어ACC^AS077|테크ACC^AS078|기타소품^BE011|토너/에멀전/크림^BE012|세럼/앰플/오일/밤^BE013|클렌징/스크럽/마스크^BE031|핸드·바디로션/크림/오일^BE032|핸드·바디워시/스크럽^BE033|샴푸/컨디셔너^BE034|트리트먼트/오일/스프레이^BE035|기타 바디/헤어케어^BE041|향수^EG02|감사^LS|라이프스타일^LS011|패브릭^LS012|프래그런스^LS013|데코레이션^LS014|기타소품^LS021|스킨케어^LS022|욕실용품^LS031|그릇^LS032|보드/트레이^LS033|커트러리^LS034|커피/티^LS035|패브릭/냅킨^LS036|기타소품^LS041|문구^LS042|책^LS043|기타소품^LS051|패션^LS052|기타소품^LS061|의류^LS062|잡화^ME011|티셔츠^ME012|셔츠^ME013|니트^ME015|가디건/베스트^ME021|루즈/테이퍼드^ME022|데님^ME023|쇼츠^ME025|슬림/스트레이트^ME028|조거/트랙^ME031|재킷^ME032|점퍼^ME033|트렌치코트^ME034|코트^ME035|다운/패딩^ME041|드레스셔츠^ME042|수트재킷^ME044|수트팬츠^ME094|SYSTEM HOMME : PARIS PRESENTATION^ME095|TIME HOMME : ONLINE EXCLUSIVE^WE011|티셔츠^WE012|블라우스^WE013|셔츠^WE014|니트^WE015|가디건/베스트^WE021|캐주얼^WE022|포멀^WE023|데님^WE024|쇼츠^WE031|미니 스커트^WE032|펜슬 스커트^WE033|플레어 스커트^WE034|롱/맥시 스커트^WE041|미니 드레스^WE042|미디 드레스^WE043|롱/맥시 드레스^WE051|재킷^WE052|점퍼^WE053|트렌치 코트^WE054|코트^WE055|다운/패딩^WE091|OBZEE : ICONIC OBZEE^WE092|TIME : SIGNATURE SUIT^WE096|FOURM STUDIO : RE:STUDIO^WE098|SYSTEM : PARIS PRESENTATION^WE09Q|LATT : with 신민아^WE09W|MINE : CODE MINE B"; //WE011|티셔츠^WE012|블라우스^...
                var cateArr = null;
                var returnCateName = "";
                if (targetCateCode != "") {
                    if (cates != "") {
    ...
    <script
        src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/943253288/?random=1647012378284&amp;cv=9&amp;fst=1647012378284&amp;num=1&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=375603260&amp;u_h=1440&amp;u_w=2560&amp;u_ah=1400&amp;u_aw=2560&amp;u_cd=24&amp;u_his=4&amp;u_tz=540&amp;u_java=false&amp;u_nplug=5&amp;u_nmime=2&amp;sendb=1&amp;ig=1&amp;frm=0&amp;url=https%3A%2F%2Fwww.thehandsome.com%2Fko%2Fmember%2Flogin&amp;ref=http%3A%2F%2Fwww.thehandsome.com%2F&amp;tiba=%ED%95%9C%EC%84%AC%EB%A1%9C%EA%B7%B8%EC%9D%B8%20%7C%20%EB%8D%94%ED%95%9C%EC%84%AC%EB%8B%B7%EC%BB%B4&amp;hn=www.googleadservices.com&amp;rfmt=3&amp;fmt=4"></script>
...
<div id="bodyWrap" class="login">
      ...
      <ul class="sub_menu" style ="font-family: "맑은 고딕", "Malgun Gothic", "돋움", Dotum, Helvetica, Arial, Sans-serif;">
         ...
         <li><a href="../mypage/OrderList.jsp" style="border-bottom: 1px solid #c4c4c4; letter-spacing: -1px; font-size: 20px;  width: 140px;">구매내역조회</a></li>
   ...
   <div class="content mypage_sub01_01">
      <h3 class="tit_page">
        <!--  <img src="../images/tit_page_mypage_sub01.png" alt="회원정보변경"> -->
      </h3>
      <form action =  "../BoardServlet?command=delete" method="post" style="margin-right:650px;">
         <fieldset style ="padding: 20px 0 26px 220px;">
            <p style="border-bottom: 1px solid #c4c4c4; letter-spacing: -1px; 
            font-size: 20px;  width: 140px; margin-bottom: 30px; 
            text-align : center; margin-left :135px;letter-spacing: 3px;">
            회원정보삭제</p>
   
            <div class="boxcontent_userform">
               <p class="txt_heading" style = "font-size : 12pt">
                  회원님의 정보보호를 위해 비밀번호를 다시 한번 확인합니다.<br>
                  비밀번호가 타인에게 노출되지 않도록 항상 주의하시기 바랍니다.
               </p>
               <ul class="list_inputgroup" style = "margin-top : 10px;">
                  <li style = "margin-top : 20px;">
                  
                  <span class="label" style = "font-size : 12pt">아이디 :
	              
					      <%
							session = request.getSession();
							out.print(session.getAttribute("login.id"));
							
						  %>
				  
				  </span>
                  </li >
                  <li><label for="wrtPassword" style = "font-size : 12pt; margin-top:10px;" >비밀번호</label>
                  <input type="password" autocomplete="off" class="text" name="user_pwd" id="wrtPassword" maxlength="30" style="width:215px;">
                  </li>
               </ul>
            </div>
        <!--     <div class="button02_ar" style =" margin-top: 20px;">
               <span class="btn_type5"> -->
				  ...
				  width: 415px;
				  opacity: 0.9;
				  position: inherit;"><span>확인</span></button>
		<!-- 	   </span> -->
       <!--      </div> -->
         </fieldset>
      </form>
